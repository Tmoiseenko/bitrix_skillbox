...
// Range conversion
	...
	function getStep ( xPct, xSteps, snap, value ) {
		...
		// If 'snap' is set, steps.preview are used as fixed points on the slider.
		if ( snap ) {
...
// Interface
	...
	function Spectrum ( entry, snap, direction, singleStep ) {
		...
		// Convert all numeric steps.preview to the percentage of the subrange they represent.
  ...
  var cssClasses = [
	...
	function generateSpread ( density, mode, group ) {
		...
		group.forEach(function ( current, index ) {
			...
			// When using 'steps.preview' mode, use the provided steps.preview.
			...
			// Find all steps.preview in the subrange.
